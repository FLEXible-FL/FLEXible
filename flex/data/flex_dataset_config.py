...
class FlexDatasetConfig:
    ...
    | **group_by_feature**    | N             | N                | N           | N                     | N               | N                      | N                       | N                      | -                    |
    ...
    def validate(self):
        ...
        self.__check_incompatibility(self_dict, "n_clients", "group_by_feature")
        self.__check_incompatibility(self_dict, "client_names", "group_by_feature")
