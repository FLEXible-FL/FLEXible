...
class TestFlexAggregators(unittest.TestCase):
    ...
    def _fixture_weights(self):
        self._torch_weights = simulate_clients_weights_for_module(n_clients=5, modulename="torch")
        self._tf_weights = simulate_clients_weights_for_module(n_clients=5, modulename="tensorflow")
        self._np_weights = simulate_clients_weights_for_module(n_clients=5, modulename="numpy")
